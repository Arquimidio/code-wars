...
function nouveau (Constructor, ...rest) {
  const returnVal = Constructor();
  if(returnVal === null) return 'the global context';
  if(typeof returnVal  === 'object' || typeof returnVal === 'function') return returnVal;
  const newObj = {};
  newObj.__proto__ = Constructor.prototype;
  Constructor.call(newObj, ...rest);
  return newObj;
}